...
app.run(
    ...
    options: [
        .category(name: "Burger", desc: "앵거스 비프 통살을 다져만든 버거", options: [
        ...
        .category(name: "Frozen Custard", desc: "매장에서 신선하게 만드는 아이스크림", options: [
